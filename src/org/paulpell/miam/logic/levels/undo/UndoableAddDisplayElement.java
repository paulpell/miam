...
public class UndoableAddDisplayElement implements UndoableAction
{

	EditorDisplayElement ede_;
	Collection <EditorDisplayElement> edes_;
	
	public UndoableAddDisplayElement(EditorDisplayElement ede, Collection <EditorDisplayElement> edes)
	{
		ede_ = ede;
		edes_ = edes;
	}
